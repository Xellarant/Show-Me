...
function scrape_showTime($title, $genres, $sYear, $eYear, $mRate){
...
$url = "http://www.imdb.com/search/title?title=$title&genres=$genres&now_playing=restrict&count=250&release_date=$sYear-01-01,$eYear-12-31&user_rating=$mRate,10.0";
...
//match movie id
preg_match_all('!<span class="userRatingValue" id="urv_tt(.*?)"!',$result,$match);
$movies['id'] = $match[1];
